    ...
    <div className="product-detail">
      ...
      <div className="product-content">
        ...
        <div className="thumbnail-list">
            <img src="Public/images/pinckgy.svg" alt="Thumbnail 1" />
            <img src="Public/images/pinckgy.svg" alt="Thumbnail 2" />
            <img src="Public/images/pinckgy.svg" alt="Thumbnail 3" />
            <img src="Public/images/pinckgy.svg" alt="Thumbnail 4" />
          </div>
          <img src="Public/images/pinckgy.svg" alt="Asgaard Sofa" className="main-image" />
        </div>
        
        <div className="product-info">
          <h1>Pingky</h1>
          <p className="price">pinckgy</p>
    ...
    <section>
      <div className="container">
        <div className="images">
          <img src="Public/images/pinckgy.svg" alt="" />
          <img src="Public/images/pinckgy.svg" alt="" />
        </div>
      </div>
    </section>
