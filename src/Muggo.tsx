    ...
    <div className="product-detail">
      ...
      <div className="product-content">
        ...
        <div className="thumbnail-list">
            <img src="src/images/muggo.svg" alt="Thumbnail 1" />
            <img src="src/images/muggo.svg" alt="Thumbnail 2" />
            <img src="src/images/muggo.svg" alt="Thumbnail 3" />
            <img src="src/images/muggo.svg" alt="Thumbnail 4" />
          </div>
          <img src="src/images/muggo.svg" alt="Asgaard Sofa" className="main-image" />
        </div>
