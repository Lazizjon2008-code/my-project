    ...
    <section className='hero_of_section'>
      <div className="container">
        <div className='title_of_hero'>
          ...
          <h2>Blog</h2>
          <h5>Home <img src="Public/images/vector.svg" alt="" /> Shop</h5>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className='blog'>
          ...
          <div className='planning'>
            <img src="Public/images/planning_work.svg" alt="" />
            ...
            <div className='about_plan'>
              ...
              <div className='person'>
                <img src="Public/images/data.svg" alt="" />
                <p>14 Oct 2022</p>
              </div>
              <div className='person'>
                <img src="Public/images/wood.svg" alt="" />
                <p>Wood</p>
              </div>
            </div>
          </div>
          ...
          <div className='categories'>
            <form action="">
              ...
              <button><img src="Public/images/searching.svg" alt="" /></button>
            </form>
      ...
      <div className="container">
        <div className='all_given_informations'>
          <div className='informations_about_blog'>
            ...
            <img className='image' src="Public/images/hand.svg" alt="" />
            <div className='about_plan'>
              <div className='person'>
                <img src="Public/images/people.svg" alt="" />
                <p>Admin</p>
            ...
            <img className='image' src="Public/images/sunglasses.svg" alt="" />
            <div className='about_plan'>
              <div className='person'>
                <img src="Public/images/people.svg" alt="" />
                <p>Admin</p>
          ...
          <div className='main_recent'>
            ...
            <h3>Recent Posts</h3>
              ...
              <div className='posts'>
                <img src="Public/images/cofee.svg" alt="" />
                <div>
                  <h5>Going all-in with <br /> millennial design</h5>
                  <p>03 Aug 2022</p>
                </div>
              ...
              <div className='posts'>
                <img src="Public/images/chair.svg" alt="" />
                <div>
                  <h5>Going all-in with <br /> millennial design</h5>
                  <p>03 Aug 2022</p>
                </div>
